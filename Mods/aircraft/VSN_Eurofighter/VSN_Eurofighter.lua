...
VSN_Eurofighter =  {
		...
		Name 			= 'VSN_Eurofighter',--AG
		DisplayName		= _('Eurofighter Typhoon'),--AG
        Picture 		= "VSN_Eurofighter.png",
        Rate 			= "50",
        Shape			= "VSN_Eurofighter",		
        WorldID			=  WSTYPE_PLACEHOLDER, 
        
	shape_table_data 	= 
	{
		{
			file  	 	= 'VSN_Eurofighter';--AG
			life  	 	= 20; -- lifebar
			vis   	 	= 3; -- visibility gain.
			desrt    	= 'VSN_Eurofighter-oblomok'; -- Name of destroyed object file name
			fire  	 	= { 300, 2}; -- Fire on the ground after destoyed: 300sec 2m
			username	= 'VSN_Eurofighter';--AG
...
add_aircraft(VSN_Eurofighter) --AG
